...
<?php endif; ?>
        ...
        <?php echo csrf_field(); ?>
            ...
            <div class="mb-4 text-center text-lg"><?php echo e(__('Log in')); ?></div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['class' => 'py-2 mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'py-2 mt-2']); ?>
...
<?php endif; ?>
                <?php if(Route::has('password.request')): ?>
                    <a class="py-2 underline text-m text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mb-2" href="<?php echo e(route('password.request')); ?>">
                        <?php echo e(__('Forgot your password?')); ?>

                    </a>
                <?php endif; ?>
                <a class="py-1 underline text-m text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mb-2" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\rere\resources\views/auth/login.blade.php ENDPATH**/ ?>